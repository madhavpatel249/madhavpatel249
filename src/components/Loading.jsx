  ...
  useEffect(() => {
    const updateProgress = () => {
      setProgress((prev) => {
        ...
        // Much faster loading for recruiters (8x speed)
        let increment = 16 // Very fast speed for 50-100
        if (prev < 50) {
          increment = 12.8 // Very fast speed for 0-50
        }
    ...
    intervalRef.current = setInterval(updateProgress, 3)
